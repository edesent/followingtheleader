        ...
        <div className="mx-auto max-w-3xl px-5 py-10 text-center sm:px-8 sm:py-12">
          <Reveal>
            ...
            <p className="mt-3 text-sm text-muted">
              Give securely by card. Joe follows up personally either way.
            </p>
          </Reveal>

          {/* Give by mail, right here under the button — a donor who would
              rather write a check should never have to hunt for the address. */}
          <Reveal delay={80}>
            <div
              id="by-mail"
              className="mx-auto mt-8 max-w-xl scroll-mt-[84px] rounded-2xl border border-gold/40 bg-paper p-7 shadow-sm sm:p-8"
            >
              <p className="eyebrow text-gold">{INVEST.mail.eyebrow}</p>
              <p className="mt-3.5 text-[0.95rem] text-body">
                {INVEST.mail.payable}{" "}
                <span className="font-semibold text-ink">{INVEST.mail.payee}</span>
              </p>
